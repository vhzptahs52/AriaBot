...
@media only screen and (max-width: 550px) {
  ...
  <body >
      <div class="logo"><div class="container">
      	<img src="phantomaria.jpg"/><h1><br>ChatBOT  ARIA</h1>
      </div></div>
      ...
      <div class="main"><div class="container"> <!-- start MAIN and CONTAINER -->
      	...
      	<div id="topPanel"> <!-- start TOP PANEL -->
      		<h4>Aria IS READY TO CHAT.</h4>
      		<div class="avatarHolder"><img id="avatarImage" src="aria.jpg" alt="avatar image" height="auto" width="100%" style="border-radius: 12px;" > </div>
      		<div id="chatbox">
...
<script type="text/javascript">
var botName = 'Aria';		// change this to your bot name
